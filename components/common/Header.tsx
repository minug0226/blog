...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 mx-auto max-w-[1080px] bg-white bg-opacity-50">
        <div className="flex justify-between">
          ...
          <div className="flex flex-1">
            ...
            <div className="flex flex-1 items-center justify-center">기술</div>
            <div className="flex flex-1 items-center justify-center">
              디자인
            </div>
            <div className="flex flex-1 items-center justify-center">기타</div>
          </div>
